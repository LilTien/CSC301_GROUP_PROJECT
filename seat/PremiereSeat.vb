...
Public Class PremiereSeat

    Private Const Rows As Integer = 3
    Private Const Columns As Integer = 6
    Private Const SeatCost As Integer = 55
    ...
    Private time As Integer = Reserve.intTime
    Private theaterID As Integer = Reserve.intTheater
    Public receiptID As String
    Public itemID As String
    Private currentDate As DateTime = DateTime.Now

    Private Sub PremiereSeat_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        CreateSeatSection(700, 250, 3, 2)
        CreateSeatSection(1100, 250, 3, 4)

        ' Initialize and add the label for total cost
        lblTotal = New Label()
        lblTotal.Location = New Point(1600, 50) ' Adjust position as needed
